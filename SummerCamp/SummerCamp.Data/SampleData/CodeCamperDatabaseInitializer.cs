...
{ 
    public class CodeCamperDatabaseInitializer :
        //CreateDatabaseIfNotExists<SummerCampDbContext>      // when model is stable
        DropCreateDatabaseIfModelChanges<SummerCampDbContext> // when iterating
    {
        ...
        protected override void Seed(SummerCampDbContext context)
        {
            // Seed code here
        ...
        private List<Room> AddRooms(SummerCampDbContext context)
        {
        ...
        private List<TimeSlot> AddTimeSlots(SummerCampDbContext context)
        {
        ...
        private List<Track> AddTracks(SummerCampDbContext context)
        {
        ...
        private List<Person> AddPersons(SummerCampDbContext context, int count)
        {
        ...
        private void AddAttendance(SummerCampDbContext context, IEnumerable<Person> attendees)
        {
